...
@Entity
@Table(name = "tariffrates_india")
public class IndiaTariff implements Tariff {
    @Id
    ...
    public IndiaTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
