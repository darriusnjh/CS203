...
@Entity
@Table(name = "tariffrates_france")
public class FranceTariff implements Tariff {
    @Id
    ...
    public FranceTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
