...
@Entity
@Table(name = "tariffrates_indonesia")
public class IndonesiaTariff implements Tariff {
    @Id
    ...
    // Default constructor
    public IndonesiaTariff() {
    }

    // Constructor with parameters
    public IndonesiaTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
