...
@Entity
@Table(name = "tariffrates_south_africa")
public class SouthAfricaTariff implements Tariff {
    @Id
    ...
    // Default constructor
    public SouthAfricaTariff() {
    }

    // Constructor with parameters
    public SouthAfricaTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
