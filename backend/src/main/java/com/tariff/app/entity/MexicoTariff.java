...
@Entity
@Table(name = "tariffrates_mexico")
public class MexicoTariff implements Tariff {
    @Id
    ...
    public MexicoTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
