...
@Entity
@Table(name = "tariffrates_china")
public class ChinaTariff implements Tariff {
    @Id
    ...
    public ChinaTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
