...
@Entity
@Table(name = "tariffrates_japan")
public class JapanTariff implements Tariff {
    @Id
    ...
    public JapanTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
