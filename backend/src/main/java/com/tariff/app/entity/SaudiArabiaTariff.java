...
@Entity
@Table(name = "tariffrates_saudi_arabia")
public class SaudiArabiaTariff implements Tariff {
    @Id
    ...
    // Default constructor
    public SaudiArabiaTariff() {
    }

    // Constructor with parameters
    public SaudiArabiaTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
