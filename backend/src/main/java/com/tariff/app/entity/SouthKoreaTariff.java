...
@Entity
@Table(name = "tariffrates_south_korea")
public class SouthKoreaTariff implements Tariff {
    @Id
    ...
    // Default constructor
    public SouthKoreaTariff() {
    }

    // Constructor with parameters
    public SouthKoreaTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
