...
@Entity
@Table(name = "tariffrates_italy")
public class ItalyTariff implements Tariff {
    @Id
    ...
    public ItalyTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
