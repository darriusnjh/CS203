...
@Entity
@Table(name = "tariffrates_turkey")
public class TurkeyTariff implements Tariff {
    @Id
    ...
    public TurkeyTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
