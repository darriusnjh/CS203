...
@Entity
@Table(name = "tariffrates_brazil")
public class BrazilTariff implements Tariff {
    @Id
    ...
    public BrazilTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
