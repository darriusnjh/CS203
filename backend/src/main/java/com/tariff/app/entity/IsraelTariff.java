...
@Entity
@Table(name = "tariffrates_israel")
public class IsraelTariff implements Tariff {
    @Id
    ...
    public IsraelTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
