...
@Entity
@Table(name = "tariffrates_australia")
public class AustraliaTariff implements Tariff {
    @Id
    ...
    // Default constructor
    public AustraliaTariff() {
    }

    // Constructor with parameters
    public AustraliaTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
