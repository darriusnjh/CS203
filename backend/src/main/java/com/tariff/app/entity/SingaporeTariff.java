...
@Entity
@Table(name = "tariffrates_singapore")
public class SingaporeTariff implements Tariff {
    @Id
    ...
    // Default constructor
    public SingaporeTariff() {
    }

    // Constructor with parameters
    public SingaporeTariff(Long id, String hts8, String briefDescription, Double mfnAdValRate) {
        this.id = id;
        this.hts8 = hts8;
